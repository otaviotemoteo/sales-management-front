...
import { SalesReportTable } from '@/components/admin/reports/sales-report-table'
...
function downloadCsv(rows: ReportRow[]) {
  const header = ['ID', 'Customer', 'Seller', 'Data', 'Payment', 'Valor', 'Status']
  const lines = [
    header.join(';'),
    ...rows.map((r) =>
      [
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Overview of every sale</p>
        </div>
        <Button
          variant="outline"
          className="gap-2"
