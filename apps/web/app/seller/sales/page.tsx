...
import { SalesFilters } from '@/components/seller/sales/sales-filters'
import { SaleStatusFilter } from '@/components/seller/sales/sale-status-filter'
import { SaleCard } from '@/components/seller/sales/sale-card'
import { SaleActionsMenu } from '@/components/seller/sales/sale-actions-menu'
import { NewSaleForm } from '@/components/seller/sales/new-sale-form'
import { SaleReceipt } from '@/components/seller/sales/sale-receipt'
                ...
                <SaleActionsMenu
                  ...
                  onDelete={async () => {
                    try {
                      ...
                      toast({ title: 'Could not cancel the sale', variant: 'destructive' })
                    }
                  }}
                />
              </div>
