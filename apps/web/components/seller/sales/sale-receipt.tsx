    ...
    <Card className="p-4 w-full">
      ...
      <div className="text-center mb-6 text-sm">
        <p className="text-muted-foreground">
          Payment: <span className="font-semibold text-foreground">{PAYMENT_METHOD_LABELS[sale.paymentMethod] ?? sale.paymentMethod} · {PAYMENT_STATUS_LABELS[sale.paymentStatus] ?? sale.paymentStatus}</span>
        </p>
      </div>
