...
// Generic, not ZodString: every caller below refines its schema, and .refine()
// returns ZodEffects rather than ZodString.
...
const profileSchema = z.object({
  ...
  state: optional(
    z.string().regex(/^[A-Z]{2}$/, { message: 'Use the 2-letter code, e.g. NY' }),
  ),
