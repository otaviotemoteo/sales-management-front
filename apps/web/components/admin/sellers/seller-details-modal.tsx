...
import { ShoppingCart, DollarSign, Users, TrendingUp, Calendar } from 'lucide-react'
...
export function SellerDetailsModal({ seller }: SellerDetailsModalProps) {
  ...
  const stats = [
    { icon: ShoppingCart, label: 'Total sales', value: seller.stats.totalSales, color: 'bg-blue-100 text-blue-600' },
    {
      icon: DollarSign,
      label: 'Faturamento',
    ...
    { icon: Users, label: 'Customers', value: seller.stats.totalCustomers, color: 'bg-purple-100 text-purple-600' },
    {
      icon: TrendingUp,
