...
export function SalesStats({ totalSales, totalRevenue, pendingValue, completionRate, paymentBreakdown }: SalesStatsProps) {
  const stats = [
    {
      icon: ShoppingCart,
      label: 'Total sales',
  ...
  return (
    <div className="space-y-4">
      ...
      {paymentBreakdown.length > 0 && (
        <Card className="p-4">
          <p className="text-sm font-medium text-foreground mb-3">Payment methods</p>
          {/* Stacked bar */}
