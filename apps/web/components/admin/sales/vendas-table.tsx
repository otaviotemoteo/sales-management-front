...
export function SalesTable({ sales, onStatusChange, onEdit, onViewDetail }: SalesTableProps) {
  if (sales.length === 0) {
    return (
      <Card className="p-12 text-center">
        <p className="text-muted-foreground">No sales match the selected filters</p>
      </Card>
    )
  }
